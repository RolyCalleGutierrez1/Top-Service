...
namespace PR_Top_Service_MVC.Controllers
{
    public class PostulationController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdPostulation,ProfessionalTitles,Certifications,WorkExperience,Date,Address,Status,IdProfessional")] Postulation postulation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPostulation,ProfessionalTitles,Certifications,WorkExperience,Date,Address,Status,IdProfessional")] Postulation postulation)
        {
