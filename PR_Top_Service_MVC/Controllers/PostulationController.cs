...
namespace PR_Top_Service_MVC.Controllers
{
    public class PostulationController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdPostulation,ProfessionalTitles,Certification,WorkExperience,Date,Address,Status,IdProfessional")] Postulation postulation)
        {
