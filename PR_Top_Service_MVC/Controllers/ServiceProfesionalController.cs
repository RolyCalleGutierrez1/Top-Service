...
namespace PR_Top_Service_MVC.Controllers
{
    public class ServiceProfesionalController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdService,IdAdmin,IdProfessional,Name,Description,Date,Status,Status_Service,DateTime_On_Service,DateTime_Off_Service,Latitude,Longitude")] Service service)
        {
